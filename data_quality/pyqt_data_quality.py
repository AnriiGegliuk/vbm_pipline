...
class MRISegmentValidator(QtWidgets.QWidget):
    ...
    def update_labels(self):
        ...
        image_type = self.get_image_type(self.file_paths[self.current_file_idx])
        self.image_type_label.setText(f"Image Type: {image_type}")
    ...
    def get_image_type(self, file_path):
        ...
        if filename.startswith('rc1'):
            return "rc1"
        elif filename.startswith('rc2'):
            return "rc2"
        elif filename.startswith('rc3'):
            return "rc3"
        return "Unknown"
